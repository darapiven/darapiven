...
Here, I ran SQL queries in BigQuery on the theLook eCommerce dataset for data exploration and analysis. Other work was made on dataset Ecommerce Dataset for Data Analysis from Kaggle. In this part I made an EDA in Python, a dashboard that answers analytical questions and linear regression.
